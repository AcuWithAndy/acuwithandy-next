...
>
  Eczema Overview
    ...
    <p className="mt-8 text-lg leading-8 text-[#1F2A24]/80">
      Eczema is a chronic inflammatory skin condition that can affect sleep,
      stress levels, confidence, and daily comfort. Symptoms often include:
    </p>
  ...
  height={500}
  priority
  className="h-32 w-full object-cover object-[center_18%]"
/>
  </div>
  ...
  <p className="mt-3 text-center text-xs italic text-[#1F2A24]/60">
    ...
    <p className="mt-10 text-lg leading-8 text-[#1F2A24]/80">
      ...
      imbalance and visible skin symptoms through Chinese herbal medicine and
...
>
  <div className="mx-auto max-w-3xl">
    ...
    <p className="mt-8 text-lg leading-8 text-[#1F2A24]/80">
      In Traditional Chinese Medicine (TCM), eczema is viewed as a pattern of
      internal imbalance combined with external pathogenic factors affecting
      the skin. Classical Chinese medicine texts describe eczema as conditions
      such as Shi Zhen ("damp eruption") and Feng Shi Chuang ("wind-damp sore").
      Common TCM patterns associated with eczema include:
    </p>
...
<div style={{ height: "50px" }} />
    <p className="mt-14 text-lg leading-8 text-[#1F2A24]/80">
      Dietary factors such as spicy, greasy, or overly rich foods may also
      contribute to internal heat and dampness that can worsen eczema symptoms.
    </p>
  </div>
</section>
...
>
  <div className="mx-auto max-w-3xl">
    ...
    <p className="mt-8 text-lg leading-8 text-[#1F2A24]/80">
      Based on your eczema presentation, sessions may include acupuncture,
      Chinese herbal medicine, cupping, gua sha, and lifestyle guidance to help
      reduce inflammation, chronic itching, flare-ups, and nervous system
      dysregulation while supporting skin health.
    </p>
...
<div style={{ height: "50px" }} />
    <div className="mt-14 space-y-10">
      {[
        ...
        <div
          key={title}
          className="border-b border-[#D4C0B4] pb-8 last:border-b-0"
        >
          <h3
            className="text-3xl leading-tight text-[#1F2A24] md:text-4xl"
            style={{ fontFamily: "var(--font-heading)" }}
          >
            {title}
          </h3>

          <p className="mt-4 text-lg leading-8 text-[#1F2A24]/75">
            {text}
          </p>
        </div>
      ))}
  ...
  {[
    ...
    <div key={question} className="border-b border-[#D9D4C9] pb-8">
      <h3
        className="text-2xl md:text-3xl leading-tight text-[#1F2A24]"
        style={{ fontFamily: "var(--font-heading)" }}
      >
        {question}
      </h3>
        ...
        <section className="bg-[#5B767B] px-6 py-20 text-center text-[#FCFCF8]">
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mt-6 text-lg leading-8 text-[#FCFCF8]/80">
             Book an appointment
              at our Manhattan-based clinic to begin a personalized treatment
              plan using acupuncture and Chinese herbal medicine for chronic
              eczema relief and long-term skin health.
            </p>
